...
for qname in query:
    ...
    handle = Entrez.efetch(db="biosample", id=query, retmode="xml")
    ...
    try:
        ...
        # Extract and print information from the BioSample record
        # This example prints the entire XML structure, but you can extract specific tags
