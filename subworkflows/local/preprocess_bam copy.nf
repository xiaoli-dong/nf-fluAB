...
workflow PREPROCESS_BAM {   
        ...
        main:
            ...
            /*
            ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
            plot per base coverage of the genes
            ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
            */
        ...
        */
        ...
        ch_bam_bai = SAMTOOLS_VIEW_RM_SEC_SUP.out.bam.join(SAMTOOLS_VIEW_RM_SEC_SUP.out.bai)//.view()
        ...
        */
        ...
        if(!params.skip_rm_soft_hard_clip){
            ...
            ch_bam_bai =  SAMTOOLS_SORT_SAMCLIP.out.bam_bai
